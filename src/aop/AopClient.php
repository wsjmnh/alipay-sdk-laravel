...
class AopClient
{
    ...
    public function __construct()
    {
        ...
        $this->rsaPrivateKeyFilePath = config('alipay.rsaPrivateKeyFilePath');
        ...
        $this->alipayPublicKey = config('alipay.alipayPublicKey');
        $this->debugInfo = config('alipay.debugInfo');
        $this->fileCharset = config('alipay.fileCharset');
        $this->RESPONSE_SUFFIX = config('alipay.RESPONSE_SUFFIX');
        $this->ERROR_RESPONSE = config('alipay.ERROR_RESPONSE');
        $this->SIGN_NODE_NAME = config('alipay.SIGN_NODE_NAME');
        $this->ENCRYPT_XML_NODE_NAME = config('alipay.ENCRYPT_XML_NODE_NAME');
        $this->needEncrypt = config('alipay.needEncrypt');
        $this->signType = config('alipay.signType');
        $this->encryptKey = config('alipay.encryptKey');
        $this->encryptType = config('alipay.encryptType');
        $this->alipaySdkVersion = config('alipay.alipaySdkVersion');
    }
